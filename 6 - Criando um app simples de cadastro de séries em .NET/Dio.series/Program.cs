...
namespace Dio.series
{
    class Program
    {
        ...
        private static void AtualizarSerie()
        {
            ...
            System.Console.WriteLine("Digite o ano de inico da serie: ");
        ...
        private static void ListarSerie()
        {
            ...
            
            {
                ...
                System.Console.WriteLine("#ID {0}: {1} {2}", serie.retornaId(), serie.RetornarTitulo(), (excluido ? "*Excluido*" : ""));
            }
        ...
        {
            System.Console.WriteLine("Inserie nova série");
            ...
            System.Console.WriteLine("Digite o ano de início da serie: ");
            int entradaAno = int.Parse(Console.ReadLine());
